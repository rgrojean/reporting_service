...
From each record it projects exactly four things into the snapshot: the Riverbend MRN (`identifier[]` entry with system `urn:riverbend:mrn` — carried only as `patientId`, a dedup key within the pull; it appears in no mart and no report), `gender`, `dob` (bucketed immediately into age bands at aggregation time), and `address.zip` (grouped to ZIP3 in all outputs). Everything else in the payload is dropped at projection (`pick()` with an explicit field list) — including `given[]`, `family`, and any non-Riverbend identifier systems — a deliberate choice from the 2022 privacy review: Lighthouse's snapshots were classified as a low-sensitivity store precisely because the projection keeps identifiers and contact data out, and the team wants to keep that classification. Records without a `urn:riverbend:mrn` identifier are skipped; if more than 0.5% of a pull lack that system (or any other picked field), the collector aborts. It also reads the roster response's paging envelope (`meta.total`, `meta.nextPage`) both for iteration and as the numerator of the panel-size reports themselves.
...
Postgres marts (`panel_monthly`, `cohort_agesex`, `cohort_geo`) plus the dated snapshot store on disk. Snapshots are retained 8 quarters to cover restatement requests on the regulatory extract. No names (`given[]` / `family`), SSNs, phone numbers, or street addresses exist anywhere in Lighthouse — the projection is the boundary.
...
## Data Samples
{
  "data": [
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "550001" }
      ],
      "given": ["Ravi"],
      "family": "Patel",
      "dob": "04/17/1968",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "550002" }
      ],
      "given": ["Diego"],
      "family": "Ortiz",
      "dob": "02/11/1995",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200105" }
      ],
      "given": ["James"],
      "family": "Mitchell",
      "dob": "05/22/1966",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200106" }
      ],
      "given": ["Emily"],
      "family": "Turner",
      "dob": "08/08/1994",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200107" }
      ],
      "given": ["Carl"],
      "family": "Phillips",
      "dob": "11/16/1959",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200108" }
      ],
      "given": ["Ruth"],
      "family": "Campbell",
      "dob": "02/02/1981",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200109" }
      ],
      "given": ["Thomas"],
      "family": "Parker",
      "dob": "06/29/1970",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200110" }
      ],
      "given": ["Gloria"],
      "family": "Evans",
      "dob": "10/10/1948",
    ...
    {
      "identifier": [
        { "system": "urn:riverbend:mrn", "value": "200111" }
      ],
      "given": ["Frank"],
      "family": "Edwards",
      "dob": "03/13/1989",
